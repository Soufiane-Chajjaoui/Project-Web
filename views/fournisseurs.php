...
<main>
                    <div class="container-fluid px-4 ">
                        <h1 class="mt-4">Fourniseurs</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Fourniseurs</li>
                        </ol>
                        <hr>
                        <div class="row">
                                    ...
                                    <div class="container ">
                                        ...
                                        <div class="col-12 col-lg-12 col-xl-12">
                                            ...
                                            <div class="card-body p-2 p-md-4 shadow p-0 mb-0 bg-body rounded">
                                                ...
                                                <!-- Form in model-->
                                                <form  action="../routes/addFournisseur.php" method="POST"  enctype="multipart/form-data" >
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple" class="table table-bordered table-striped">
                                   ...
                                   <tbody> 
                                        ...
                                        <?php 
                                           $listfourni = Fournisseur::listeFournisseurs() ;
                                           foreach($listfourni as $fournisseur){
                                           ?>

                                        <tr>
                                        <td><center><img src="<?= $fournisseur->photo ;?>" title="<?= $fournisseur->prenom . " " .$fournisseur->nom ;?>"  width="32px" height="28px" width="32px" height="28px"  alt="" ></center></td>
                                            ...
                                            <td>
                                                <a href="../views/Update.php?id=<?=$fournisseur->id?>">
                                                 <center><i class="fa fa-wrench fa-2x" aria-hidden="true"></i></center>
                                               </a>
                                                </td>
                                            <td>
                                            <a href="../routes/SoftDelete.php?id=<?=$fournisseur->id?>&role_as=<?=$fournisseur->role?>" onclick="return confirm('Are you sure you want to delete this Fournisseur <?= strtoupper($fournisseur->prenom  .' '. $fournisseur->nom) ;?>')">
